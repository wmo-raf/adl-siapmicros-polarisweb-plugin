...
An ADL Plugin for collecting observation data from SIAP+Micros Polaris Web API
...
The ADL SIAPMicros PolarisWeb Plugin is a module intended to be installed in an [ADL](https://github.com/wmo-raf/adl)
...
### Install ADL SIAPMicros PolarisWeb Plugin

The `dev.Dockerfile` file uses the `adl` image as a base image. The `ADL SIAPMicros PolarisWeb Plugin` is
